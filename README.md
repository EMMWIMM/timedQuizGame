...
made questions humorous and engaging.
-made sure the score and given initials were stored in the browser's local storage.
-was sure that upon the timer running out or the complete set of questions being fully answered that the game would come to an end and indicate that the player should -input their initials to be saved with their score.
